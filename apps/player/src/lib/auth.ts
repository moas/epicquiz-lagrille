...
export function subscribeToToken(subscriber: (value: string | null) => void) { subscribers.add(subscriber); return () => subscribers.delete(subscriber); }
