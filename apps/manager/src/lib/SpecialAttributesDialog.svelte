<script lang="ts">
	...
	async function addPrize() {
		...
		isSaving = true; errorMessage = '';
		try {
			attributes = [...attributes, await createPrizeAttribute(episodeId, { name: prizeName.trim(), description: prizeDescription.trim() || undefined, image: prizeImage })];
			prizeName = ''; prizeDescription = ''; prizeImage = null; onchange(attributes);
